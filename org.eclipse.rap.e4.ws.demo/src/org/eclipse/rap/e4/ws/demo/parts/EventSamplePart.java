package org.eclipse.rap.e4.ws.demo.parts;
...
public class EventSamplePart {
  ...
  private void createSendGroup(Composite parent, final String topicType) {
    ...
    b.addSelectionListener(new SelectionAdapter() {
		private static final long serialVersionUID = 4010748791317669648L;
    ...
    b.addSelectionListener(new SelectionAdapter() {
		private static final long serialVersionUID = -2547037375900675990L;
